    ...
    <>
      <section class="bg-white dark:bg-gray-900">
        <div class="max-w-full py-4 px-2 w-full h-full scrollbar-hide overflow-x-scroll">
          <div class="live-preview flex h-full w-full not-prose">
            <div class="flex w-full flex-col">
              <div data-slot="base" class="inline-flex" aria-label="Options">
                <div
                  class="flex p-1 h-fit gap-2 items-center flex-nowrap overflow-x-scroll scrollbar-hide bg-transparent dark:bg-transparent border-medium border-default-200 shadow-sm rounded-medium"
