  ...
  return (
    <body class="bg-gray-50 dark:bg-slate-900">
          ...
          <div class="w-full flex items-center justify-end ms-auto sm:justify-between sm:gap-x-3 sm:order-3">
            ...
            <div class="hidden sm:block">
              ...
              <div class="relative">
                <div class="absolute inset-y-0 start-0 flex items-center pointer-events-none z-20 ps-4">
                  <svg
                    class="flex-shrink-0 h-4 w-4 text-gray-500"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
            ...
            <div class="flex flex-row items-center justify-end gap-2">
              ...
              >
                ...
                <div
                  class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-100 min-w-[15rem] z-10 bg-white shadow-md rounded-lg p-2 dark:bg-gray-800 dark:border dark:border-gray-700"
                ...
                >
                  <div class="py-3 px-5 -m-2 bg-gray-100 rounded-t-lg dark:bg-gray-700">
                    ...
                    <p class="text-sm font-medium text-gray-800 dark:text-gray-300">
                      {/* {session?.user?.email.match(/^([^@]*)@/)[1]} */}
                      {session?.user?.name}

                      {/* {session?.user?.email}james@site.com */}
                    </p>
                  </div>
      ...
      <div
        ...
        class={` -translate-x-full transition-all duration-300 transform fixed top-0 start-0 bottom-0 z-[60] w-64 bg-white border-e border-gray-200 pt-7 pb-10 overflow-y-auto lg:block lg:translate-x-0 lg:end-auto lg:bottom-0 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-slate-700 dark:[&::-webkit-scrollbar-thumb]:bg-slate-500 dark:bg-gray-800 dark:border-gray-700 ${
          openNavbar ? "block translate-x-0" : "hidden"
        }`}
      >
        <div ref={modal} class="px-6">
          <a
