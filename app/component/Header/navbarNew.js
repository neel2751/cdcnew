...
const NavbarNew = () => {
  ...
  return (
    <>
      <div className=" sticky left-0 top-0 flex items-center h-20 z-40 bg-[#EAF3F5]mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5">
        <div className="w-full flex justify-between h-14 items-center">
          <div className="h-full flex items-center gap-x-4 text-[#242A3D] dark:text-gray-300">
              ...
              <div className="overflow-hidden overflow-y-auto max-h-[75vh] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-slate-700 dark:[&::-webkit-scrollbar-thumb]:bg-slate-500">
                <div className="flex flex-col gap-x-0 mt-5 divide-y divide-dashed divide-gray-200 md:flex-row md:items-center md:justify-end md:gap-x-7 md:mt-0 md:ps-7 md:divide-y-0 md:divide-solid dark:divide-gray-700">
                  ...
                  >
                    ...
                    {/* Start submenu */}
                    <div
                      className={`duration-[0.1ms] md:duration-[150ms] w-full ${
                        isOpen ? "block" : "hidden"
                      } absolute -mt-2 z-10 top-full start-0 min-w-[15rem] bg-white md:shadow-2xl rounded-lg py-2 md:p-4 dark:bg-gray-800 dark:divide-gray-700 before:start-0 before:w-full before:h-5`}
                    >
